...
// src/utils/url.js
import path2 from "path-webpack";
var Url = class {
  ...
  resolve(what) {
    ...
    fullpath = path2.resolve(this.directory, what);
   ...
   */
  relative(what) {
    return path2.relative(what, this.directory);
  }
  /**
   * @returns {string}
   */
...
// src/container.js
import path3 from "path-webpack";
var Container = class {
  ...
  parse(containerDocument) {
    ...
    this.directory = path3.dirname(this.packagePath);
...
// src/resources.js
import path4 from "path-webpack";
var Resources = class {
...
var ContinuousViewManager = class extends default_default {
  ...
  scrolled() {
    ...
    clearTimeout(this.afterScrolled);
    this.afterScrolled = setTimeout(function() {
      Promise.resolve(scrolledTask).catch(function() {
      }).then(function() {
...
// src/index.js
var index_default = epub_default;
export {
